import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application21/presentation/sign_up_complete_account_screen/models/sign_up_complete_account_model.dart';import 'package:basri_s_application21/data/models/registerDeviceAuth/post_register_device_auth_resp.dart';import 'package:basri_s_application21/data/models/registerDeviceAuth/post_register_device_auth_req.dart';import 'dart:async';import 'package:basri_s_application21/data/repository/repository.dart';import 'package:basri_s_application21/core/constants/user.dart';import 'package:basri_s_application21/core/constants/role.dart';part 'sign_up_complete_account_event.dart';part 'sign_up_complete_account_state.dart';/// A bloc that manages the state of a SignUpCompleteAccount according to the event that is dispatched to it.
