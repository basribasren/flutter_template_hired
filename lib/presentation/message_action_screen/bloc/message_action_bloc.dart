import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/message_action_item_model.dart';import 'package:basri_s_application21/presentation/message_action_screen/models/message_action_model.dart';part 'message_action_event.dart';part 'message_action_state.dart';/// A bloc that manages the state of a MessageAction according to the event that is dispatched to it.
