import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import 'package:basri_s_application21/presentation/enter_otp_screen/models/enter_otp_model.dart';import 'package:sms_autofill/sms_autofill.dart';part 'enter_otp_event.dart';part 'enter_otp_state.dart';/// A bloc that manages the state of a EnterOtp according to the event that is dispatched to it.
