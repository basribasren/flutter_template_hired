import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/saved_item_model.dart';import 'package:basri_s_application21/presentation/saved_page/models/saved_model.dart';part 'saved_event.dart';part 'saved_state.dart';/// A bloc that manages the state of a Saved according to the event that is dispatched to it.
